class Recipe {
  ...
  Recipe(this.title,this.timestamp,this.pic,this.description,this.prepTime,this.cookTime,this.servings,this.ingredients,this.directions);
}
List<Recipe> recipes = [
  new Recipe("Potato Samosa","February 04, 2019","https://foodiebells.com/img/recipes/potato-samosas/samosa.jpg",
              ...
              [
                ...
                "1 jar imli/pudeena/mango chutney (optional)"
              ...
              [
                ...
                "Bake the samosas for 20 to 25 minutes, until they turn golden.",
                "Serve with the Imli, Pudina or Mango chutney."
              ]
